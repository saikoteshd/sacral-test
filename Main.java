...
class BankService {
     ...
     * Also validates if any account balance is less than zero and prints a warning.
     */
    public void printAllAccounts() {
        ...
        for (Account acc : accounts.values()) {
            ...
            if (acc.getBalance() < 0) {
                System.out.printf("WARNING: Account %s has a negative balance!%n", acc.getName());
                logger.log(Level.WARNING, "Account {0} has a negative balance: {1}", new Object[]{acc.getName(), acc.getBalance()});
            }
        }
                        ...
                        switch (option) {
                            ...
                            case "3" -> {
                                ...
                                if (acc != null) {
                                    ...
                                    System.out.printf("Name: %s, Balance: %.2f%n", acc.getName(), acc.getBalance());
                                    if (acc.getBalance() < 0) {
                                        System.out.printf("WARNING: Your account has a negative balance!%n");
                                        logger.log(Level.WARNING, "Account {0} has a negative balance: {1}", new Object[]{acc.getName(), acc.getBalance()});
                                    }
